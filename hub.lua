...
'Coin_Server'then local m=ab.dist3d(g.Position,l.Position)if m<j and m>5 then j=m i=l end end end if i then d=i ab.safeTweenToPart(i)end end end end end end)
