...
if not aa then aa={c=__modImpl()}a.cache.B=aa end return aa.c end end end local aa=a.b()aa.WaitForGameAndPlayer()local ab=a.e()a.f()a.A()local ac=a.B()ab.
Library:LoadConfiguration()if ac.DexToggle.CurrentValue then ac.dex_injected=true loadstring(game:HttpGet
