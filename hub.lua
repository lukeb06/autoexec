...
=ab.dist3d(g.Position,l.Position)if m<j then j=m i=l end end end if i and(not d or not d.Parent)then ab.safeTweenToPart(i)end end end end end end)task.spawn(
