...
then local h,i=ab.getLocalRoot(),e.Character local j=i and i:FindFirstChild'HumanoidRootPart'if h and j then local k=ab.dir3d(j.Position,h.Position)h.CFrame=h.
CFrame*CFrame.new(k*(20-g))end return true end return false end while task.wait()do if b and not ab.get_safeTweening()then local d=game:GetService'Players'.
