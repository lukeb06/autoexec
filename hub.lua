...
function cancelTween(d)if coinCollected(d)then return true end if plrDistToMurderer()<=20 then local e=ab.getLocalRoot()e.CFrame=e.CFrame*CFrame.new(0,0,10)
