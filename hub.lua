...
game:GetService'Players':GetPlayers())do if ab.plrHasGun(af)then ad=af break end end end return ad end function ab.shootPos(ae)local af=game:GetService'Players'
...
wait()ak:Activate()end end end return ab end function a.o():typeof(__modImpl())local aa=a.cache.o if not aa then aa={c=__modImpl()}a.cache.o=aa end return aa.c
end end do local function __modImpl()local aa,ab,ac=a.e(),a.b(),a.o()if game.PlaceId==142823291 then local ad=aa.Window:CreateTab('Murder Mystery 2','gamepad-2'
...
i then i=l h=k end end end if h then ab.safeTweenToPart(h)end end end end end end)end return true end function a.p():typeof(__modImpl())local aa=a.cache.p if
not aa then aa={c=__modImpl()}a.cache.p=aa end return aa.c end end do local function __modImpl()local aa,ab=a.b(),{}function ab.getZombies()local ac=game.
...
end end return ab end function a.q():typeof(__modImpl())local aa=a.cache.q if not aa then aa={c=__modImpl()}a.cache.q=aa end return aa.c end end do local 
function __modImpl()local aa,ab=a.e(),a.q()if game.GameId==1003981402 then local ac=aa.Window:CreateTab('Reminiscence Zombies','gamepad-2')ac:CreateSection'ESP'
...
CFrame=e.CFrame end end end end)end return true end function a.r():typeof(__modImpl())local aa=a.cache.r if not aa then aa={c=__modImpl()}a.cache.r=aa end
...
return ab end function a.s():typeof(__modImpl())local aa=a.cache.s if not aa then aa={c=__modImpl()}a.cache.s=aa end return aa.c end end do local function 
__modImpl()local aa,ab,ac=a.e(),a.b(),a.s()if game.PlaceId==139233844569220 then local ad=aa.Window:CreateTab('ZOO or OOF','gamepad-2')ad:CreateSection'ESP'
...
function a.t():typeof(__modImpl())local aa=a.cache.t if not aa then aa={c=__modImpl()}a.cache.t=aa end return aa.c end end do local function __modImpl()a.h()a.
j()a.l()a.n()a.p()a.r()a.t()return true end function a.u():typeof(__modImpl())local aa=a.cache.u if not aa then aa={c=__modImpl()}a.cache.u=aa end return aa.c
end end do local function __modImpl()local aa,ab=a.e(),{}local ac=aa.Window:CreateTab('Externals','telescope')ac:CreateSection'Dex'ab.dex_injected=false ab.
...
Flag='LoadRSOnStartup',Callback=function(ag)end}return ab end function a.v():typeof(__modImpl())local aa=a.cache.v if not aa then aa={c=__modImpl()}a.cache.v=aa
end return aa.c end end end local aa=a.b()aa.WaitForGameAndPlayer()local ab=a.e()a.f()a.u()local ac=a.v()ab.Library:LoadConfiguration()if ac.DexToggle.
